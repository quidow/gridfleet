"""Reproducer for bug 1: AGENT_GRID_NODE_HEARTBEAT_SEC is silently ignored.

See ``docs/superpowers/specs/2026-05-20-agent-bug-audit.md`` (Bug 1).
"""
...
async def test_grid_node_heartbeat_sec_env_value_propagates_to_config(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(agent_settings.grid_node, "grid_node_heartbeat_sec", 99.0)
    ...
    assert config.heartbeat_sec == 99.0  # type: ignore[attr-defined]
