"""Reproducer for bug 3: AGENT_GRID_NODE_PROXY_TIMEOUT_SEC is silently ignored.

See ``docs/superpowers/specs/2026-05-20-agent-bug-audit.md`` (Bug 3).
"""
...
async def test_grid_node_proxy_timeout_sec_env_value_propagates_to_config(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(agent_settings.grid_node, "grid_node_proxy_timeout_sec", 17.5)
    ...
    assert config.proxy_timeout_sec == 17.5  # type: ignore[attr-defined]
