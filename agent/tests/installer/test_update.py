...
from agent_app.installer.update import UpdateResult, format_update_dry_run, update_agent
...
def test_update_agent_runs_pip_restart_and_health_check_on_linux(tmp_path: Path) -> None:
    config = _make_config(tmp_path)
