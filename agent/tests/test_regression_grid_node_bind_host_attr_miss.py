"""Reproducer for bug 4: AGENT_GRID_NODE_BIND_HOST is silently ignored in GridNodeConfig.

See ``docs/superpowers/specs/2026-05-20-agent-bug-audit.md`` (Bug 4).
"""
...
async def test_grid_node_bind_host_env_value_propagates_to_config(
    ...
    assert config.bind_host == "127.0.0.1"  # type: ignore[attr-defined]
