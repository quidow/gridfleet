...
import { SetupVerificationModal } from './SetupVerificationModal';
...
vi.mock('../../hooks/useDevices', () => ({
  useStartExistingDeviceVerification: () => ({
    mutateAsync: vi.fn(),
    isPending: false,
    isError: false,
  }),
...
function renderModal() {
  ...
  return render(
    <QueryClientProvider client={queryClient}>
      <SetupVerificationModal isOpen onClose={vi.fn()} existingDevice={makeDevice()} />
    </QueryClientProvider>,
  );
}

describe('SetupVerificationModal manifest fields', () => {
  beforeEach(() => {
