...
## [0.4.1](https://github.com/quidow/gridfleet/compare/gridfleet-frontend-v0.4.0...gridfleet-frontend-v0.4.1) (2026-07-01)


### Bug Fixes

* **frontend:** allow optional device name in run detail table type ([8add0d4](https://github.com/quidow/gridfleet/commit/8add0d4548da2257edd7c7be4fe7fbf76814b48c))
* **frontend:** replace identity/target columns with device column on run detail ([7042ac4](https://github.com/quidow/gridfleet/commit/7042ac4eb95725d384244fb8b6067487107f9f30))
* **frontend:** replace identity/target columns with device column on run detail ([1918b83](https://github.com/quidow/gridfleet/commit/1918b83a13c09a38d717efa15cbf0add9a4f5ca2))
