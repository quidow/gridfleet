...
async def _check_node_health(
    ...
    *,
    ...
    return await svc._check_node_health(node, device)
...
async def _bounded_check_node_health(
    ...
    *,
    ...
    return await svc._bounded_check_node_health(semaphore, node, device)
...
async def _attempt_node_restart(
    ...
    *,
    ...
    await svc._attempt_node_restart(db, device=device)
