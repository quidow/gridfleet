...
PUBLIC_EVENT_CATALOG: tuple[PublicEventDefinition, ...] = (
    ...
    PublicEventDefinition(
        name="device.lifecycle_incident",
        category="device_and_node_lifecycle",
        description="A device lifecycle/recovery incident was recorded (recovery paused/failed, auto-stop, etc.).",
        default_severity="info",
        allowed_severities=ALL_SEVERITIES,
        typical_data_fields=(
            "device_id",
    ...
    PublicEventDefinition(
        ...
        description="Session started on a tracked device.",
        default_severity="info",
        allowed_severities=frozenset({"info"}),
        typical_data_fields=(
            "session_id",
    ...
    PublicEventDefinition(
        name="session.ended",
        category="sessions_and_runs",
        description="Tracked session ended.",
        default_severity="info",
        allowed_severities=frozenset({"info", "success", "warning", "critical"}),
        typical_data_fields=(
            "session_id",
