...
# ──────────────────────────────────────────────────────────────────────────────
# Backward-compat free functions for routers and tests until Task 8 (PackServicesDep).
# These are FULL COPIES of the class methods above, not delegation wrappers —
# FeatureService requires publisher and circuit_breaker at construction time.
# Remove these when routers/host_features.py and dependents migrate to
