...
_DEFINITIONS: list[SettingDefinition] = [
    ...
    SettingDefinition(
        ...
        setting_type="int",
        default=5,
        description="Seconds between intent reconciler dirty queue polls.",
        min_value=1,
        max_value=300,
    ),
    SettingDefinition(
        key="general.intent_reconcile_full_scan_every_cycles",
        category="general",
        setting_type="int",
        default=720,
        description="Run a full device scan after this many intent reconciler cycles.",
        min_value=1,
        max_value=17280,
    ),
    SettingDefinition(
