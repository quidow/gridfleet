...
## [0.3.0](https://github.com/quidow/gridfleet/compare/gridfleet-backend-v0.2.0...gridfleet-backend-v0.3.0) (2026-06-12)
...
* **backend:** enforce strict run-reservation admission and retire the gridfleet:run_id capability
...
* **backend:** grid status and queue api from db
* **backend:** node health from direct probes only
* **backend:** session observation sweep replaces hub-truth session sync
...
* **backend:** accept first-class run_id on internal grid allocate ([0d3a098](https://github.com/quidow/gridfleet/commit/0d3a098cf23d0275ef724ae90beee4c397abcb2a))
* **backend:** add active filter to session list api ([8bacbb0](https://github.com/quidow/gridfleet/commit/8bacbb00c9aaa9ac4f45550c88ba7187de3af1fe))
...
* **backend:** add grid_session_queue table ([a5943f3](https://github.com/quidow/gridfleet/commit/a5943f3cf6ceea804f78d923e3976d02c6fad5cb))
...
* **backend:** add pending session status and last_activity_at ([d843807](https://github.com/quidow/gridfleet/commit/d8438076b584936b244da57a8f9c0d0ad181d1cd))
...
* **backend:** add run binding column to grid session queue tickets ([cb79b57](https://github.com/quidow/gridfleet/commit/cb79b57d9d3917f7e9236da273c7161d204edb90))
* **backend:** add sessions.actual_capabilities column ([b704161](https://github.com/quidow/gridfleet/commit/b7041618c8c11dc511180e2d1eefd65c5b0e7b67))
* **backend:** allocation confirm, fail, ended and expiry reaping ([28c19db](https://github.com/quidow/gridfleet/commit/28c19db54c87a7fd91a88f6413fd3ecf804eefb3))
* **backend:** allocation service with fifo queue claim ([3f11666](https://github.com/quidow/gridfleet/commit/3f1166686c61c5e08b6eb96200cd7b8435d2fb79))
...
* **backend:** derive device busy from pending sessions ([aec9000](https://github.com/quidow/gridfleet/commit/aec90003838734285f1d8d591a5eee114bf921e2))
* **backend:** derive device presence from direct health probes, sweep only on miss ([91f5a35](https://github.com/quidow/gridfleet/commit/91f5a35a7ca1358341a2a40a15fe2f7f4ac5839f))
...
* **backend:** direct appium http helpers ([6fa32bf](https://github.com/quidow/gridfleet/commit/6fa32bf3f22ddd6e96b5ad89e153c17005cc5e7f))
...
* **backend:** enforce strict run-reservation admission and retire the gridfleet:run_id capability ([8fb3f06](https://github.com/quidow/gridfleet/commit/8fb3f06f95ed4a5a742a54730302cd15775f64ff))
* **backend:** expose actual_capabilities and accept caps on confirm ([802c371](https://github.com/quidow/gridfleet/commit/802c3719eccc70df37b93990858dbe556c64fbbf))
* **backend:** first-command grace reap for never-commanded sessions ([55b8df9](https://github.com/quidow/gridfleet/commit/55b8df90d59010f460f41604f178d50b7595be7d))
...
* **backend:** grid allocation reaper loop and metrics ([535a54f](https://github.com/quidow/gridfleet/commit/535a54f8cbd5159d3dbc884f0a349bcdd59ad3cd))
* **backend:** grid allocation settings knobs ([aac5d24](https://github.com/quidow/gridfleet/commit/aac5d2489bfa2514d4d4d509391d7232ac9750cb))
* **backend:** grid status and queue api from db ([b84b809](https://github.com/quidow/gridfleet/commit/b84b809169b485fb8d274dd8f2a13fbb915d4606))
...
* **backend:** idle session reaper from router activity ([cd9154f](https://github.com/quidow/gridfleet/commit/cd9154f00ce72b25dc6aec5cbc521203cda51db8))
* **backend:** internal grid allocation endpoints ([8be5ca9](https://github.com/quidow/gridfleet/commit/8be5ca9e4faec2b3149dbac27b0e64121bd07789))
...
* **backend:** mirror grid node state via event-bus doorbells ([d735413](https://github.com/quidow/gridfleet/commit/d7354134fe665be286dc4b503e1a624fb3b54509))
* **backend:** node health from direct probes only ([0013afe](https://github.com/quidow/gridfleet/commit/0013afe3fa0a884bc5fcb695a9cc9fcb1c9e5c2a))
...
* **backend:** re-resolve moved pack devices by identity during property refresh ([4276cb7](https://github.com/quidow/gridfleet/commit/4276cb7ec522b099677b81f734fc72735b58183e))
...
* **backend:** run release and fleet capacity use db and direct appium ([fbf0945](https://github.com/quidow/gridfleet/commit/fbf0945cf281d347970ced1217f083674d737155))
* **backend:** send expected identity with connectivity health probes ([75daf99](https://github.com/quidow/gridfleet/commit/75daf992e48602d9e4fdf82b4a703ed419f216e7))
* **backend:** session observation sweep replaces hub-truth session sync ([1389566](https://github.com/quidow/gridfleet/commit/13895669cfb2a556efbfcad27dd9432cadaf824b))
* **backend:** store appium capabilities on session row at confirm ([aa94ec4](https://github.com/quidow/gridfleet/commit/aa94ec432cd267966cef6a3db6889f46faf3118e))
...
* **backend:** viability probes hit appium directly ([1a05029](https://github.com/quidow/gridfleet/commit/1a05029dc1841102c39f562706b720e2927a864c))
* **backend:** w3c capability merge and identity matching ([9aef262](https://github.com/quidow/gridfleet/commit/9aef262a04864887249f2615ca9c3a77a9160200))
...
* **backend:** add device_in_service withdrawal predicate ([3ebda6d](https://github.com/quidow/gridfleet/commit/3ebda6de486a856c9dfdc2ec37e9e294df06adc1))
...
* **backend:** canonicalize session_discovery into the stored pack manifest ([852bfba](https://github.com/quidow/gridfleet/commit/852bfbac1317cffbefe4d5214a3ff386d983f6bc))
...
* **backend:** claim the session close with a conditional update ([8e55169](https://github.com/quidow/gridfleet/commit/8e5516930c8aaa8e52d72baca44e6d75938e6fb5))
* **backend:** clear recovery suppression on operator start ([8891a02](https://github.com/quidow/gridfleet/commit/8891a02b63ef4706a87cc51f68ed6c6da012aab1))
* **backend:** clear recovery suppression when a device self-heals ([c6659f3](https://github.com/quidow/gridfleet/commit/c6659f3014814c6d2e5b8a356b7e2192a523b518))
...
* **backend:** clear stale offline flag on healthy devices and gate ip-ping side effects ([5f9b594](https://github.com/quidow/gridfleet/commit/5f9b5943ec5bcbcad1340e6b5ebcade7355b4968))
...
* **backend:** conditional pending transitions in confirm and fail ([ab0b611](https://github.com/quidow/gridfleet/commit/ab0b6112a6da7a649681ed90ca1385d7fda60237))
...
* **backend:** count grid absence as node failure evidence on indeterminate probe ([5cbfd38](https://github.com/quidow/gridfleet/commit/5cbfd3833071f0e42f1fec53fd48bdffd2b2f9fa))
* **backend:** count pending allocations in the public grid status ([b3a723a](https://github.com/quidow/gridfleet/commit/b3a723a16d6acc3f7bae1572a78fee32d9b6372a))
* **backend:** count pending grid allocations in the pack-drain gate ([15dd99f](https://github.com/quidow/gridfleet/commit/15dd99fdff6abf7c582e7d08c7fb49c09a962c3a))
...
* **backend:** defer graceful stop while a session is pending ([ac1ce72](https://github.com/quidow/gridfleet/commit/ac1ce72c7ac4fe34a4aa3968546532e874f40dea))
* **backend:** defer no-intent stops while a client session is active ([55e64f4](https://github.com/quidow/gridfleet/commit/55e64f49c6fbd633789f18139868173cfef105a3))
* **backend:** defer reap close when the Appium terminate fails ([a8623c2](https://github.com/quidow/gridfleet/commit/a8623c2b7a4888b12364813d538c18bf4cd1d9a2))
* **backend:** drop dead grid pytest marker and stale hub comments ([8d2709f](https://github.com/quidow/gridfleet/commit/8d2709fa8879a7295490c3ab6b1b7f47381b61a6))
...
* **backend:** emit session.started from allocation confirm ([2a425f0](https://github.com/quidow/gridfleet/commit/2a425f0a144120d448b486f9df35618928f96d3f))
* **backend:** exclude pending-window devices from orphan sweep ([8883a2f](https://github.com/quidow/gridfleet/commit/8883a2f49ea9616dfe6331d57e5b5b046e0be9c7))
...
* **backend:** expire claimed ticket on grid session run-release ([1c09984](https://github.com/quidow/gridfleet/commit/1c099840815538a7918d489749eb6a5399106fa0))
* **backend:** expose run binding on the public grid queue API ([1b4a07d](https://github.com/quidow/gridfleet/commit/1b4a07d5228848e254591a4b5095e160d27825de))
...
* **backend:** feed node-state into liveness sweep; structured verdict (C2/C3/Q13/Q20) ([e49676a](https://github.com/quidow/gridfleet/commit/e49676a4e466e90145ba7b1a24f64d5d23926eb3))
* **backend:** force-inject session_discovery into pack start payload ([9cbff25](https://github.com/quidow/gridfleet/commit/9cbff256e5c94a92c7a279c1a8831a94cb993bd9))
...
* **backend:** harden grid allocation confirm, activity, and reaper ([cae5fc3](https://github.com/quidow/gridfleet/commit/cae5fc373ce7698c51d39dd142fef46de3da891a))
* **backend:** harden grid allocation confirm, run-id, ticket liveness ([033cce7](https://github.com/quidow/gridfleet/commit/033cce7247ecf89b0449ba938bb2039b824e824c))
...
* **backend:** idempotent allocate for claimed tickets ([413bb89](https://github.com/quidow/gridfleet/commit/413bb8955228510695de66596697e4412d7da66f))
* **backend:** include pending sessions in recovery + capacity gates (C7/C13) ([30dacd3](https://github.com/quidow/gridfleet/commit/30dacd391f05446f9682d1626b8e9252ff536176))
* **backend:** kill doomed orphans on pending devices via 409-confirm id stamp ([3942731](https://github.com/quidow/gridfleet/commit/3942731a7a05e1754e1b8b6985d0ad30c8a77420))
...
* **backend:** only clear recovery suppression for stale residue ([f2be979](https://github.com/quidow/gridfleet/commit/f2be979c9a9242d0786ad29d65213d39e0451405))
...
* **backend:** persist allocation target and harden grid allocation ([e9d29c7](https://github.com/quidow/gridfleet/commit/e9d29c766fecd563e73bbb27600c70926d1ed6fd))
* **backend:** persist node health from direct probes ([b366853](https://github.com/quidow/gridfleet/commit/b3668535c7d3a3e0f5a124fbd74e16f33e19f107))
* **backend:** pin existing node port on operator start ([c9303b7](https://github.com/quidow/gridfleet/commit/c9303b7f326beb80a63609936b8fe43be19aa2be))
* **backend:** pool the direct appium http client ([3f55ca3](https://github.com/quidow/gridfleet/commit/3f55ca36bdabb9b347f1a49f0e2d1b1651545869))
...
* **backend:** probe session_sync sweeps concurrently ([6778160](https://github.com/quidow/gridfleet/commit/6778160bf1a7903094a612cef5d024e035e3d657))
* **backend:** propagate pending session status through run-release and gating ([fb77c98](https://github.com/quidow/gridfleet/commit/fb77c9831fea7a4af858896fab61868b3a880670))
...
* **backend:** refence leadership after slow sweep probes ([ad4b8cc](https://github.com/quidow/gridfleet/commit/ad4b8cc08f2012c2f1c9195cd0301c1d037e7c20))
* **backend:** refresh suppression recency on re-assertion ([a1bbc6a](https://github.com/quidow/gridfleet/commit/a1bbc6a0e7e2b162269ebd0287db19724d42b281))
* **backend:** reservation-aware fifo veto ([2ea2aae](https://github.com/quidow/gridfleet/commit/2ea2aae7cdb1f73e64d3dc925c8be93835c002d1))
...
* **backend:** resolve release session target without the device row lock ([dd3c949](https://github.com/quidow/gridfleet/commit/dd3c949bb6db9703e4e41b53de41f8a9eda5c63c))
...
* **backend:** restrict refresh connection-target heal to network devices ([520332b](https://github.com/quidow/gridfleet/commit/520332b6a716cdd5f0c94d91d3fbe3af8105a13d))
...
* **backend:** review-shelved devices need attention ([52cbf01](https://github.com/quidow/gridfleet/commit/52cbf0175b03c071ca1ed0060508ec0bcafdd5a3))
...
* **backend:** satisfy vulture on the bulk activity update ([98cc056](https://github.com/quidow/gridfleet/commit/98cc0561934060981968cdc909e3747303eccaa7))
* **backend:** shared node-viability predicate for both allocators ([f2c23d0](https://github.com/quidow/gridfleet/commit/f2c23d0aa31adf0360cc1af2d0219f4f32dc141b))
* **backend:** shared session close with run-terminal status ([cd79096](https://github.com/quidow/gridfleet/commit/cd79096cb5778b90b76f98f4f2f667d2f92d9860))
* **backend:** shelved devices must stop their appium node ([1e8938e](https://github.com/quidow/gridfleet/commit/1e8938e757324cd44f4dad4195ac2080e44296b6))
...
* **backend:** skip orphan sweep for any pending row and batch its queries ([167c430](https://github.com/quidow/gridfleet/commit/167c4308c53cd2311cccc44750ba544fa312f87a))
* **backend:** stop baseline node starts on review-shelved devices ([0bd7eb8](https://github.com/quidow/gridfleet/commit/0bd7eb89344ceba9b52c587ce064377fff72f088))
* **backend:** stop committing mid connectivity cycle on self-heal clear ([d52267d](https://github.com/quidow/gridfleet/commit/d52267dc22cdd69de5195b4458c7e0625c73c38f))
* **backend:** stop in-process alembic from disabling app loggers ([6a08841](https://github.com/quidow/gridfleet/commit/6a0884148a15c86bb424c820435e6e2b2a62b88c))
...
* **backend:** stop observed-state writes from clearing node health signals ([#506](https://github.com/quidow/gridfleet/issues/506)) ([34d6970](https://github.com/quidow/gridfleet/commit/34d6970e16463e81edc6c764ca134ba127c3b1b2))
* **backend:** suppress session.ended for never-confirmed pending rows (C12) ([120344e](https://github.com/quidow/gridfleet/commit/120344eae8d7359683d97aa54ef7c0372054ee31))
* **backend:** surface stereotype lookup failures and cache pack templates per attempt ([6a73154](https://github.com/quidow/gridfleet/commit/6a73154ba2757badd39bc91d5de5ad0b16df3a3c))
* **backend:** surface the capability merge detail in the allocate 400 ([6168b98](https://github.com/quidow/gridfleet/commit/6168b987c5b59466220bf742bef8255fabe86597))
...
* **backend:** terminalize and purge allocation queue tickets ([2898e34](https://github.com/quidow/gridfleet/commit/2898e34762c0329db3e9c6d06e61357655238ce4))
...
* **backend:** treat run_id free sentinel as silent free session ([8a2416e](https://github.com/quidow/gridfleet/commit/8a2416e827e02d2de87cf6d21d6f06190ae8e250))
* **backend:** wake session_sync sweep after reaper frees a pending device (P2) ([4319996](https://github.com/quidow/gridfleet/commit/4319996ece1447e8ea735d7b7f12510d7e26cf6b))
* **backend:** warn on pack ingest when session_discovery is missing ([6a22106](https://github.com/quidow/gridfleet/commit/6a221061f285253841ef6e68767a9911df176169))
* **backend:** widen allocation claim window and expose it in allocate response ([76a0656](https://github.com/quidow/gridfleet/commit/76a0656b0b8612d3dd30d080d11d44cf9d8b7b9d))
...
* **backend:** drop redundant standalone grid queue status index ([69cd6e0](https://github.com/quidow/gridfleet/commit/69cd6e0cd3637f276eb3f2ead9266d13dc5ee108))
...
* **backend:** gather run-release Appium terminates per host ([d7e492d](https://github.com/quidow/gridfleet/commit/d7e492d9bff46ff8d0ca11fc9f45f9d954f55ada))
...
* **backend:** partial index for the live-session scans (Q21) ([a8accb3](https://github.com/quidow/gridfleet/commit/a8accb36536712a045271f8ba452c1eb249cc28b))
...
* **backend:** skip liveness probes for recently-active sessions ([afe33c5](https://github.com/quidow/gridfleet/commit/afe33c52b17caa667fa80faf92f6efa77e7f6450))
...
* **deps:** bump the python-dependencies group ([#516](https://github.com/quidow/gridfleet/issues/516)) ([de3dc64](https://github.com/quidow/gridfleet/commit/de3dc64d51c8f68a403009ac14255eff5e94b7b6))
...
* **backend:** clarify allocation comments and log broken node targets ([6f1189d](https://github.com/quidow/gridfleet/commit/6f1189d55157e4b2c53a9f0688a2ce5fb641ef39))
