...
## [0.8.3](https://github.com/quidow/gridfleet/compare/gridfleet-backend-v0.8.2...gridfleet-backend-v0.8.3) (2026-09-05)


### Dependencies

* **deps:** bump datamodel-code-generator ([#1022](https://github.com/quidow/gridfleet/issues/1022)) ([878f202](https://github.com/quidow/gridfleet/commit/878f202eb1c1b2c590dd743a5e92373135c765b5))
* **deps:** bump ruff in /backend in the python-dependencies group ([#1016](https://github.com/quidow/gridfleet/issues/1016)) ([8ed3d6b](https://github.com/quidow/gridfleet/commit/8ed3d6b73a2ab612dccee63c45357cef2bb5cfe1))

## [0.8.2](https://github.com/quidow/gridfleet/compare/gridfleet-backend-v0.8.1...gridfleet-backend-v0.8.2) (2026-08-28)
...
* **deps:** bump datamodel-code-generator ([#1011](https://github.com/quidow/gridfleet/issues/1011)) ([c54a4f8](https://github.com/quidow/gridfleet/commit/c54a4f8a35a0d0849480440b06440a69317c494d))
...
* **deps:** bump the python-dependencies group ([#1006](https://github.com/quidow/gridfleet/issues/1006)) ([2239f64](https://github.com/quidow/gridfleet/commit/2239f6421c997bbd5739241603efe56d5d06cc33))
...
* **deps:** bump ruff in /backend in the python-dependencies group ([#946](https://github.com/quidow/gridfleet/issues/946)) ([4531020](https://github.com/quidow/gridfleet/commit/453102081573a59c7c2b1a39ea1814187c651af6))

## [0.7.0](https://github.com/quidow/gridfleet/compare/gridfleet-backend-v0.6.0...gridfleet-backend-v0.7.0) (2026-08-02)


### ⚠ BREAKING CHANGES

* **backend:** remove the device review shelving flag and columns
* **backend:** drop the recovery review threshold and retry forever

### Features

* **backend:** add a bounded one-connection engine for the outbox poller ([8612b8e](https://github.com/quidow/gridfleet/commit/8612b8e7246fb046b235deae9f3bea5b5a6aa489))
...
* **backend:** add crash-safe pack artifact ledger ([ca00b2a](https://github.com/quidow/gridfleet/commit/ca00b2a20c89aa23213f93fc1ef15dc6f5a67a0a))
...
* **backend:** add pack artifact ledger write helpers ([b3d455b](https://github.com/quidow/gridfleet/commit/b3d455b6815fd6fed448e9072a3fbc6199d61dcc))
* **backend:** add the pack_artifacts ledger table ([37905c4](https://github.com/quidow/gridfleet/commit/37905c446d355d6731dd4778e60e2309a0b62516))
* **backend:** bound one outbox poll statement on a measured value ([311101d](https://github.com/quidow/gridfleet/commit/311101ddacb4dfbf55a9e2383d5f84ace2bc5b57))
* **backend:** commit system events with their source transaction ([d6ad954](https://github.com/quidow/gridfleet/commit/d6ad954b628fb63ea57e9e5abe6775a7113dbe18))
* **backend:** count deferred and truncated session-viability series ([70fdc34](https://github.com/quidow/gridfleet/commit/70fdc349bda073fda19bde84217e369e665f4aa5))
* **backend:** drop the recovery review threshold and retry forever ([a929834](https://github.com/quidow/gridfleet/commit/a92983415b9de349157d3d5835ebd5c102ec21bc))
* **backend:** drop the review and blocked rungs from state projections ([c289df1](https://github.com/quidow/gridfleet/commit/c289df16cb8a5e2dce8555b11479ac711b170ea1))
* **backend:** export outbox poll age and pending-gap count ([cbce13f](https://github.com/quidow/gridfleet/commit/cbce13fd028df53cb874529d084663ceb723d109))
* **backend:** instrument the scheduled viability pass and pin its starvation path ([5eda898](https://github.com/quidow/gridfleet/commit/5eda8988a85526c3e82cca0dfa5d6ba0e7a65ed5))
* **backend:** normalize dynamic group references ([7faea65](https://github.com/quidow/gridfleet/commit/7faea65e77466b16c9a90da5f07fbf8b34afdd58))
* **backend:** notify system event inserts after commit ([7d3ca5b](https://github.com/quidow/gridfleet/commit/7d3ca5b0f13a529cddd127d94c0e3617e8f2e11d))
* **backend:** orphan pack artifact ledger rows on delete ([8d890c7](https://github.com/quidow/gridfleet/commit/8d890c70c2904f967402581fbbd2fb72769d616d))
...
* **backend:** prove every device-scoped decision write holds the device row lock ([41ac7bb](https://github.com/quidow/gridfleet/commit/41ac7bb932afaebf6569b81da69ee3938734af64))
* **backend:** reap orphaned and stale pack artifacts from the janitor ([1791f69](https://github.com/quidow/gridfleet/commit/1791f6912f9f524a9b9700468e749d85f48fec59))
* **backend:** remove the device review shelving flag and columns ([997974e](https://github.com/quidow/gridfleet/commit/997974ef688a0505fc8c72550523c1b556d2e122))
* **backend:** run the outbox poller on its bounded engine ([1e73827](https://github.com/quidow/gridfleet/commit/1e7382770fd323cbdf353f1fc70e91ba3d0a33c4))
* **backend:** split pack upload into reserve, write and activate ([0e203d1](https://github.com/quidow/gridfleet/commit/0e203d1fe159f46a9e28e129d8d4185906e074fb))
* **backend:** stop shelving devices on failed re-verification ([b929033](https://github.com/quidow/gridfleet/commit/b9290337deb2f145b5672e6d092ecd418497c253))
* **backend:** widen the device history filter to failure and maintenance events ([4225627](https://github.com/quidow/gridfleet/commit/42256270d51c22d1a3b0d6803d75e7161e23bf23))
...
* **backend:** admit scheduled retry probes on viability-parked devices ([fa62ced](https://github.com/quidow/gridfleet/commit/fa62ced4c80f13d0eed93a69a009b43b43ec8bf2))
* **backend:** aggregate blocker lock modes and pin join predicates ([608da41](https://github.com/quidow/gridfleet/commit/608da41e0ddb042f6821a3f2f1a29720632610aa))
* **backend:** anchor the viability pass budget at the sweep tick start ([0863985](https://github.com/quidow/gridfleet/commit/0863985c252c2ecc0508a6777f225a39cae0829d))
* **backend:** announce every remediation backoff the shared ladder arms ([70f0d43](https://github.com/quidow/gridfleet/commit/70f0d4346e1cb892a7642779118e6360f985b792))
* **backend:** apply the phase 9 whole-branch review fix wave ([65ee90f](https://github.com/quidow/gridfleet/commit/65ee90f6c6246d6dc4209a56bb915323d015c780))
* **backend:** back off listener reconnect logging during an outage ([00dc9fa](https://github.com/quidow/gridfleet/commit/00dc9fa2f8fc856dc5005ebba0ea990f902ba32a))
* **backend:** back off outbox poller failure logging during an outage ([314610b](https://github.com/quidow/gridfleet/commit/314610b2ad87c088e93cd7cd31abeb841bdbf5ba))
* **backend:** bound preparation failure lock waits ([a83f7eb](https://github.com/quidow/gridfleet/commit/a83f7eb2f41d667dc9ffd0e9ba4b915015bc797d))
* **backend:** bound scheduled viability attempts by the pass deadline ([0f4166c](https://github.com/quidow/gridfleet/commit/0f4166c72607928ddaf06ddfb7a5f1c8252f28ff))
* **backend:** bound the retention passes by liveness and backoff ([c9f12ab](https://github.com/quidow/gridfleet/commit/c9f12ab3e4c500fab2c541e44123bcffd4dea5bb))
* **backend:** break the group reference writer deadlock ([f472cd7](https://github.com/quidow/gridfleet/commit/f472cd7e69e5279317558dc2eaa9e5af976df5b2))
* **backend:** cap probe terminate and anchor the viability pass budget at tick start ([39f404d](https://github.com/quidow/gridfleet/commit/39f404d878407d389655999f9d2e163d47a1f340))
* **backend:** cap the probe terminate timeout below the create budget ([1a48275](https://github.com/quidow/gridfleet/commit/1a48275f0077384ad1aa0263b3426113eb8ec981))
* **backend:** capture lock blocker details ([2b46859](https://github.com/quidow/gridfleet/commit/2b46859b84c8ce8532055bc93fd718707a27fe47))
* **backend:** catch the bare TimeoutError a command_timeout cutoff raises ([3e65d3c](https://github.com/quidow/gridfleet/commit/3e65d3c5132fd76ccf89178bca4b44e87f3c9ed7))
* **backend:** clear the review flag when a node start succeeds ([d1f9c99](https://github.com/quidow/gridfleet/commit/d1f9c996aef1eb2347546bc2d5a10471f1fb40d9))
* **backend:** close claimed sessions on ticket cancel ([9fd1643](https://github.com/quidow/gridfleet/commit/9fd164354a8426ba43d682d519f41bcfcd039a11))
...
* **backend:** close the P1 review gaps in the node-unreachable fold ([87f4e73](https://github.com/quidow/gridfleet/commit/87f4e73cd93fa6fc739037128c6dded5ed76dd29))
...
* **backend:** contain post-commit pack artifact ledger cleanup ([8b098f3](https://github.com/quidow/gridfleet/commit/8b098f3aa5de4cedb701a96dc82a76ac0f6a0580))
...
* **backend:** dedupe outbox delivery by committed row id ([0ef4e38](https://github.com/quidow/gridfleet/commit/0ef4e38450c7c190a7a6dd5a634b03a762a3d7e3))
* **backend:** describe the viability threshold as attempts per scheduled pass ([b4ae2e3](https://github.com/quidow/gridfleet/commit/b4ae2e37dab3a2abbefebb364cbc1090b4f55b60))
...
* **backend:** enforce pack artifact state constraint ([56edc00](https://github.com/quidow/gridfleet/commit/56edc000ba9ba02345b2d6afd8dfbace9f06dd60))
* **backend:** fail closed on OR/subquery/operator gaps in bulk lock-guard scan ([cb56c0e](https://github.com/quidow/gridfleet/commit/cb56c0e77a1f6a23604c1097fadb9b43a737e973))
* **backend:** fence pack artifact upload reservations ([dc30276](https://github.com/quidow/gridfleet/commit/dc302765879f619b7e1adca59d05b87b8a9015fa))
* **backend:** gate the outbox watermark on an assigned transaction id ([a24f9ed](https://github.com/quidow/gridfleet/commit/a24f9ed290c6c5962252c58661a000e00ada826d))
* **backend:** give the boot-fence rejection an actionable error code ([dd82a84](https://github.com/quidow/gridfleet/commit/dd82a84cec3d67ef39cf9cbf410231129be3dc24))
...
* **backend:** hold the outbox watermark behind in-flight transactions ([963a144](https://github.com/quidow/gridfleet/commit/963a14425f1ccc028e7761f694c18aaaac0875ae))
* **backend:** ingest agent start failures independent of recovery backoff ([e613d1a](https://github.com/quidow/gridfleet/commit/e613d1adcbedb7adb7b1d34f138f2cb2273061de))
* **backend:** keep polling when gap resolution fails, and aggregate its alarm ([4e1c182](https://github.com/quidow/gridfleet/commit/4e1c18208b474ec20e83e74eaf64e24f90034181))
* **backend:** log request watchdog timeouts ([7175d15](https://github.com/quidow/gridfleet/commit/7175d1571c52ca1705fad704e3f04ad6177f902f))
* **backend:** log the per-device series guard at warning ([e7e0ae4](https://github.com/quidow/gridfleet/commit/e7e0ae4375124173cc8098d8a8812a0e34f83ffa))
...
* **backend:** move node ownership with a desired-port repin ([c2ea493](https://github.com/quidow/gridfleet/commit/c2ea493028c227df0fde126fa0aa7b38f536e597))
* **backend:** name the decision-writer guard for what it checks ([56c7a40](https://github.com/quidow/gridfleet/commit/56c7a40383124ef4f0c16e6bc887095cb280a0ba))
* **backend:** name the readiness lapse so the recovery skip catch is really narrow ([e749f48](https://github.com/quidow/gridfleet/commit/e749f48247eda67bfd1312d4011ec49e11e10598))
* **backend:** order group definition locks parent before edge ([4b1534b](https://github.com/quidow/gridfleet/commit/4b1534b8c7deeaa81ce389a58c645ab89fed6c5c))
...
* **backend:** pin group reference endpoint kinds in the schema ([9785280](https://github.com/quidow/gridfleet/commit/9785280f1771bee2609c1a832280ef6cdefffb00))
* **backend:** pin the reconnect lock reversal and narrow the command 404 gate ([012cf65](https://github.com/quidow/gridfleet/commit/012cf657a675ee6cfdd944b06e69a7752de7a78f))
* **backend:** re-pin the no-intent-stop test and drop the dead device param ([89cd75e](https://github.com/quidow/gridfleet/commit/89cd75e86b400db61804ac6005f78076f15f137b))
* **backend:** read testkit devices as objects in the churn driver ([2f97cfd](https://github.com/quidow/gridfleet/commit/2f97cfdff4902c722423ff8120f3fd59b390720c))
* **backend:** record re-verification probe failure in session viability ([1f579b3](https://github.com/quidow/gridfleet/commit/1f579b33eaf2aaa0e15e3525da75310e6936951a))
* **backend:** record the review shelving instead of inferring it ([9aef1f0](https://github.com/quidow/gridfleet/commit/9aef1f0cc822718c0e1da6d7b90a79fff67ff7d9))
...
* **backend:** report a superseded host boot as a conflict, not a missing host ([57561eb](https://github.com/quidow/gridfleet/commit/57561eb6cc6677a047b2941ad1c3a9b9849ebf7c))
...
* **backend:** restore recovery-gate admission proof after node carve-out ([3d9bd93](https://github.com/quidow/gridfleet/commit/3d9bd932aca03c241933b96a179ebcc8442ebe35))
...
* **backend:** rotate failed pack artifact reaper batches ([e0ff969](https://github.com/quidow/gridfleet/commit/e0ff969616b24b0481a0217cb10774fb1964015d))
* **backend:** route the scheduled viability pass through the series with a budget ([aa73f60](https://github.com/quidow/gridfleet/commit/aa73f608b72162dd472e288c4b87a6e14391a355))
* **backend:** run the scheduled session-viability probes as an in-pass series ([b9a04bf](https://github.com/quidow/gridfleet/commit/b9a04bf030b3ad01755b0e42b3bf3a261e09be0d))
* **backend:** run the scheduled viability attempts as an in-pass series ([33640e3](https://github.com/quidow/gridfleet/commit/33640e343c8571118397798847e5e7e6bcfab18b))
* **backend:** scope restart event cursors to agent boot ([69d1494](https://github.com/quidow/gridfleet/commit/69d1494fff1839d35dad252af9f528fe5e9d6c8c))
* **backend:** scope the begin_nested() docstring claim to import_bundle.py ([7a5297f](https://github.com/quidow/gridfleet/commit/7a5297f16527d5e81eb778e340de725f125ed830))
* **backend:** scope the review-clear to the episode that shelved the device ([7073f86](https://github.com/quidow/gridfleet/commit/7073f86090766615841898f50da589434a5eef7b))
* **backend:** seed poll-age from process start, not a zero fallback ([9c36852](https://github.com/quidow/gridfleet/commit/9c36852b290d807e4f668175dffe66a70212ba49))
* **backend:** skip recovery viability preconditions ([67063c7](https://github.com/quidow/gridfleet/commit/67063c73ddfed30fc97e5cb13f04e11ab28c798d))
* **backend:** skip the reservation release when the device row is gone ([24545b5](https://github.com/quidow/gridfleet/commit/24545b5ddaec179b3981554a1767ddcb078614c6))
...
* **backend:** stop telling operators to hunt a bound that is not wrong ([652394f](https://github.com/quidow/gridfleet/commit/652394fbbb28380d8011cff7fcc69d9b88998a45))
* **backend:** stop the pack command 404 lane from swallowing data bugs ([5125027](https://github.com/quidow/gridfleet/commit/512502751f89d05f65fd091f2f3d7ed81943b228))
...
* **backend:** track outbox gaps instead of gating on a transaction id ([3d800ef](https://github.com/quidow/gridfleet/commit/3d800ef0fc5d69506efa043439a7ecb3b58f61c6))
* **backend:** track outbox gaps instead of gating on a transaction id ([5944738](https://github.com/quidow/gridfleet/commit/59447389ab325d37b804f54b2fce75b3a2b6f6d0))
* **backend:** track the settings refresh task on the event bus ([441e346](https://github.com/quidow/gridfleet/commit/441e346c69dbb47b75fa68e57291009233e87f22))
* **backend:** translate the group delete reference race ([f66260b](https://github.com/quidow/gridfleet/commit/f66260bdd758abab15acdeafc1dd8f903725f0f8))
* **backend:** truncate before reversing in newer-direction pagination ([c2672c9](https://github.com/quidow/gridfleet/commit/c2672c97850cf105b13e727e91540461cc33f5e1))
* **backend:** widen the initial log-backoff window and reset it from the last report ([544a4ca](https://github.com/quidow/gridfleet/commit/544a4ca2fdb1e2ae92340d5e808d232346e3f2dd))
* **ci:** bind the idle-transaction bound to a database the suite connects to ([43a9c0a](https://github.com/quidow/gridfleet/commit/43a9c0ad21bf358ef21b9ff6095697beea8da180))
...
* **backend:** batch the driver-pack catalog read into one read per host ([f2208c4](https://github.com/quidow/gridfleet/commit/f2208c46d45074b1890cfe7ee26724dc7ddc54d9))
* **backend:** derive device-list platform labels from the pack catalog ([caa1114](https://github.com/quidow/gridfleet/commit/caa11148e4a07bf99a5c2bb2482ffc2ce017888f))
* **backend:** derive run-create platform labels from the pack catalog ([28b632c](https://github.com/quidow/gridfleet/commit/28b632c8083cd130762bf8c29ed2d38504fd7e6a))
...
* **backend:** fetch only the projected columns in the pack catalog read ([0c393f1](https://github.com/quidow/gridfleet/commit/0c393f1133c510268b8a2da01206d02e7a902a0c))
...
* **backend:** read the driver-pack catalog once per host in convergence ([f508dea](https://github.com/quidow/gridfleet/commit/f508dea52ca5b387cff9c71d583544f38ae0df2d))
...
* **backend:** trim the driver-pack catalog read to its projected columns ([ebd9715](https://github.com/quidow/gridfleet/commit/ebd9715102da0ff0d925812df2570cc436c881ac))
...
* **deps:** bump the python-dependencies group ([#923](https://github.com/quidow/gridfleet/issues/923)) ([60c3df1](https://github.com/quidow/gridfleet/commit/60c3df132c483f251611c43dd1db7829c55c9f20))
* **deps:** bump the python-dependencies group across 1 directory with 5 updates ([#910](https://github.com/quidow/gridfleet/issues/910)) ([059e4c0](https://github.com/quidow/gridfleet/commit/059e4c06e637399661f91d8bfbe227afdb5f3eb7))


### Documentation

* **backend:** correct the pack-read guard's stated limits and two stale catalog docstrings ([7477795](https://github.com/quidow/gridfleet/commit/747779535910ee258681c45dc89b5dd8d64833fc))
* **backend:** correct the pass budget comment for the cycle deadline and terminate cap ([e6f1b9c](https://github.com/quidow/gridfleet/commit/e6f1b9ced08061065c69d817e32f2d76a6a52786))
* **backend:** correct the shared Appium client's timeout comment ([56ab807](https://github.com/quidow/gridfleet/commit/56ab8073bdf43cfee8468a3826d2174472d9746d))
* **backend:** correct the stale groups.py savepoint allowlist comment ([ca50580](https://github.com/quidow/gridfleet/commit/ca505808e6b04984d350ce59524e4a93e08576b5))
* **backend:** correct three stale comments in the outbox poller ([0388ced](https://github.com/quidow/gridfleet/commit/0388cedf0ffcf3610d761e764119de9e1c32fe97))
* **backend:** correct viability comment overclaims and pin exc_info assertion ([31115f3](https://github.com/quidow/gridfleet/commit/31115f3d65968fd69b564dd0d54062dd56697598))
* **backend:** disclose exit-stack expression ceiling ([454ad92](https://github.com/quidow/gridfleet/commit/454ad926c922754a9b4a79f45da05670c1f6188b))
* **backend:** disclose the three name-shaped guards' blind spots ([2a01cf5](https://github.com/quidow/gridfleet/commit/2a01cf5460ba12b1fa04090d42b0efe4f32db424))
* **backend:** explain why EventBus preserves dedupe map across restarts ([e6b1307](https://github.com/quidow/gridfleet/commit/e6b1307dde3a921586e0b515cc94842426939bac))
* **backend:** inline the phase 11 b11/b12 follow-up reasoning ([6f548ca](https://github.com/quidow/gridfleet/commit/6f548cabb49542c07a8d5cbc18e840f692ce8e66))
* **backend:** name the rollback-storm case in the outbox gap gauge help ([139b97c](https://github.com/quidow/gridfleet/commit/139b97c9bbdd829f9d331bf94472d7d551bc8318))
* **backend:** name the safety multiple in the poll timeout derivation ([fee0ded](https://github.com/quidow/gridfleet/commit/fee0ded8c23fedeb397298d7dd9129bb7d885d92))
* **backend:** name the scheduler-only read path for the viability counters ([e96b289](https://github.com/quidow/gridfleet/commit/e96b289dffd65c11c428606ab94a59f96d5977db))
* **backend:** record that outbox delivery no longer needs the device lock ([d1e87c8](https://github.com/quidow/gridfleet/commit/d1e87c8a6d5ad1a8f356bf02df486b5ed990a43b))
* **backend:** record the phase 11 follow-up decisions ([740f3a9](https://github.com/quidow/gridfleet/commit/740f3a9205aaa96206f70d1a7ce5187e5713cfed))
* **backend:** record why the rollout intent delete needs no explicit sync ([7243d2a](https://github.com/quidow/gridfleet/commit/7243d2a41a8c079d8dd1e602f5cb44db0e267443))
* **backend:** remove exclusivity claim from sibling-test cross-reference ([dbbeed8](https://github.com/quidow/gridfleet/commit/dbbeed8b715d6d13b79d00225c77c7c70ecfbc05))
* **backend:** restore the reconcile decision rationale comments ([eac1318](https://github.com/quidow/gridfleet/commit/eac1318233fa425b9dc1830184715361a350a833))
* **backend:** scope two test claims to what their numbers support ([f158363](https://github.com/quidow/gridfleet/commit/f1583633dc405b76e9019321508e4aa3e3c2e8e3))
* **backend:** state the real preparation-failure contract and lock bound ([fb198eb](https://github.com/quidow/gridfleet/commit/fb198ebedf1a7105a93cb6511c029ed5e806c648))
* **backend:** state why node liveness is excluded from the retry carve-out ([e66f0ab](https://github.com/quidow/gridfleet/commit/e66f0ab198793367873ea951732776ba6231ef0f))
