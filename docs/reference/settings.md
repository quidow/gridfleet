...
| `general.device_check_interval_sec` | `general` | `int` | `60` | `GRIDFLEET_DEVICE_CHECK_INTERVAL_SEC` | `10..600` | Cadence of the host-sweep connectivity stage; effective period rounds to a multiple of `general.heartbeat_interval_sec` |
