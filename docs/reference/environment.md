...
| `GRIDFLEET_AGENT_LOG_SHIP_MIN_LEVEL` | `agent.log_ship_min_level` | `INFO` | Minimum agent-process log level shipped to backend storage. Valid values: `DEBUG`, `INFO`, `WARNING`, `ERROR`. |
